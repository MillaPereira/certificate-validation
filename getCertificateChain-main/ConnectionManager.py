...
class ConnectionManager:
    ...
    def get_certificate(self, secure: bool = True) -> x509.Certificate:
        ...
        try:
            ...
            sslCertificate = x509.load_pem_x509_certificate(sslCertificate.encode('ascii'), backend=default_backend())
    ...
    def get_certificate_from_uri(self, __uri: str) -> x509.Certificate:
        ...
        if aiaRequest.status_code == 200:
            ...
            certI = x509.load_pem_x509_certificate(sslCertificate.encode('ascii'), backend=default_backend())
